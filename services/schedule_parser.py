...
# Import compute_critical_path relative to this package to avoid import
# issues when `backend` is not in the top-level package path.
...
def _parse_xer(file_path: Path) -> list[Dict[str, Any]]:
    ...
    Returns:
        A list of task dictionaries with keys: id, wbs, name, start, finish.
    """
